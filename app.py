...
def index ():
    if request.method == 'POST':
        ...
        ax1.plot(ema20, 'r', label = 'EMA 50')
        ax1.set_title("Closing Price vs Time (with 20 & 50 Days EMA)")
        ax1.set_xlabel("Time")
        ...
        ax2.plot(ema20, 'g', label = 'EMA 100')
        ax2.plot(ema20, 'r', label = 'EMA 200')
        ax2.set_title("Closing Price vs Time (with 100 & 200 Days EMA)")
        ax2.set_xlabel("Time")
        ...
        ax3.plot(ema20, 'g', label = "Original Price", linewidth = 1)
        ax3.plot(ema20, 'r', label = "Predicted Price", linewidth = 1)
